-- Schéma userData.db de JW Library, schemaVersion 16, tel qu'il sort d'une vraie
-- sauvegarde (sqlite_master, sans aucune donnée). Sert à fabriquer les
-- sauvegardes factices de `backups.ts`.
